...
CHECKPOINT_PATH = os.environ.get(
    ...
    os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                 "exp_02_emotion_transformer", "best_model_fold4.pth"),
)
...
async def process(
    ...
    try:
        result = process_video(tmp_path, _model, _device,
...
# Serve frontend static files at / (mount AFTER route definitions so API routes take precedence)
