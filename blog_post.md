...
![Comparison sub159 j_1176_1220](share_friend_visuals_20260404/comparisons/sub159_sub159_j_1176_1220_comparison.png)
![Comparison sub162 c_303_374](share_friend_visuals_20260404/comparisons/sub162_sub162_c_303_374_comparison.png)
![Comparison sub184 j_643_653](share_friend_visuals_20260404/comparisons/sub184_sub184_j_643_653_comparison.png)
![Comparison sub186 j_1187_1196](share_friend_visuals_20260404/comparisons/sub186_sub186_j_1187_1196_comparison.png)
![Comparison sub187 l_4178_4188](share_friend_visuals_20260404/comparisons/sub187_sub187_l_4178_4188_comparison.png)
![Comparison sub202 g_2676_2696](share_friend_visuals_20260404/comparisons/sub202_sub202_g_2676_2696_comparison.png)
![Comparison sub207 k_27_42](share_friend_visuals_20260404/comparisons/sub207_sub207_k_27_42_comparison.png)
![Comparison sub213 g_5_24](share_friend_visuals_20260404/comparisons/sub213_sub213_g_5_24_comparison.png)
![Comparison sub216 h_2189_2199](share_friend_visuals_20260404/comparisons/sub216_sub216_h_2189_2199_comparison.png)

### Confusion Matrices By Experiment

#### Exp00 Dual-CNN (RGB)
![Exp00 RGB Confusion Matrix (generated from exp_00_dual_cnn/save_dual_cnn)](exp_00_dual_cnn/outputs/cm_combined_cnn_apex_rgb.png)

#### Exp00 Dual-CNN (Gray)
![Exp00 Gray Confusion Matrix (generated from exp_00_dual_cnn/save_dual_cnn)](exp_00_dual_cnn/outputs/cm_combined_cnn_apex_gray.png)

#### Exp01 ResNet50-Flow + SwinV2-Spatial
![Exp01 Confusion Matrix](share_friend_visuals_20260404/confusion_matrices/Exp01/Exp01_summary_with_cm.png)

#### Exp02 SwinV2-Flow + ResNet50-Spatial
![Exp02 Confusion Matrix](share_friend_visuals_20260404/confusion_matrices/Exp02/Exp02_summary_with_cm.png)

#### Exp03 ConvNeXt-Flow + ViT-Spatial
![Exp03 Confusion Matrix](share_friend_visuals_20260404/confusion_matrices/Exp03/Exp03_summary_with_cm.png)

#### Exp04 VGGFace2-Flow + Swin-Spatial
![Exp04 Confusion Matrix](share_friend_visuals_20260404/confusion_matrices/Exp04/Exp04_summary_with_cm.png)

#### Exp05 Single Swin Apex
![Exp05 Confusion Matrix](share_friend_visuals_20260404/confusion_matrices/Exp05/Exp05_summary_with_cm.png)

#### Exp06 Single ResNet Flow
![Exp06 Confusion Matrix](share_friend_visuals_20260404/confusion_matrices/Exp06/Exp06_summary_with_cm.png)

## Flow Method Comparisons (Exp00)

### RAFT vs TV-L1
![Exp00 RAFT masked comparison](exp_00_dual_cnn/raft_masked_comparison.png)
![Exp00 TV-L1 comparison](exp_00_dual_cnn/tvl1_comparison.png)
![Exp00 fixed-flow comparison](exp_00_dual_cnn/fixed_flow_comparison.png)

### TV-L1 Variant Comparisons
![Exp00 pure TV-L1 comparison](exp_00_dual_cnn/pure_tvl1_comparison.png)
![Exp00 blur TV-L1 comparison](exp_00_dual_cnn/blur_tvl1_comparison.png)
![Exp00 TV-L1 no-mask comparison](exp_00_dual_cnn/tvl1_no_mask_comparison.png)

### AMP Comparisons
![Exp00 AMP comparison](exp_00_dual_cnn/amp_comparison.png)
![Exp00 detailed AMP comparison](exp_00_dual_cnn/detailed_amp_comparison.png)
![Exp00 multiple AMP comparison](exp_00_dual_cnn/multiple_amps_comparison.png)